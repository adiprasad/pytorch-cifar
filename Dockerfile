...
#RUN /bin/bash "echo The app is running! && sleep 3600"
#RUN ldconfig /usr/local/cuda/targets/x86_64-linux/lib/stubs && \
#    python -c "import horovod.torch as hvd; hvd.init(); print(hvd.size())" && \
#    sleep 3600 \
#    ldconfig
